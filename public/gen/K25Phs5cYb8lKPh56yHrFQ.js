...
view._makeAll({
  "main.html:body": "<span>List of databases</span><select value=\"{{dbs}}\"></select><div>{{#each collections}}<option value=\"{{name}}\">{{name}}</option>{{/}}    </div><pre><code>{{collections}}</code></pre>",
  "main.html:doctype": "",
  "main.html:footer": "",
  "main.html:header": "",
