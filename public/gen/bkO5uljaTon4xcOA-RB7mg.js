...
view._makeAll({
  "main.html:body": "<span>List of databases</span><select value=\"{{dbName}}\">{{#each dbs.databases}}<option value=\"{{name}}\">{{name}}</option>{{/}}</select><div>{{#each collections}}<option value=\"{{name}}\">{{name}}</option>{{/}}    </div><pre><code>{{collections}}</code></pre>",
  "main.html:doctype": "",
  "main.html:footer": "",
  "main.html:header": "",
